...
fn test_schedule() -> Schedule {
    Schedule {
        charge_start: 0.0, charge_end: 5.5,
        discharge_start: 17.0, discharge_end: 20.0,
...
fn schedule_roundtrip_preserves_all_fields() {
    let sched = Schedule {
        charge_start: 22.0, charge_end: 6.0,
        discharge_start: 17.0, discharge_end: 20.0,
        charge_start_2: 14.0, charge_end_2: 16.0,
        discharge_start_2: 0.0, discharge_end_2: 0.0,
        charge_target_soc: 90.0, charge_target_soc_2: 85.0,
        discharge_target_soc: 15.0, discharge_target_soc_2: 20.0,
        charge_start_3: 0.0, charge_end_3: 0.0, charge_target_soc_3: 100.0,
        charge_start_4: 0.0, charge_end_4: 0.0, charge_target_soc_4: 100.0,
        charge_start_5: 0.0, charge_end_5: 0.0, charge_target_soc_5: 100.0,
        charge_start_6: 0.0, charge_end_6: 0.0, charge_target_soc_6: 100.0,
